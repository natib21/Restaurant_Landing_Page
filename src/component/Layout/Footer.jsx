    ...
    <footer className="bg-gray-950 text-gray-300">
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 leading-relaxed mb-6">
              The all-in-one digital solution for Ethiopian restaurants. 
              From QR menus to multi-branch management — built for cafes, hotels, 
              fast food, and traditional restaurants.
            </p>
            <div className="flex space-x-4">
              <a href="https://facebook.com/menuroom" target="_blank" rel="noopener noreferrer"
                 className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-orange-600 transition">
                <Facebook className="w-5 h-5" />
              </a>
              <a href="https://instagram.com/menuroom.et" target="_blank" rel="noopener noreferrer"
                 className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-orange-600 transition">
                <Instagram className="w-5 h-5" />
              </a>
              <a href="https://twitter.com/menuroomet" target="_blank" rel="noopener noreferrer"
                 className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-orange-600 transition">
                <Twitter className="w-5 h-5" />
              </a>
              <a href="https://youtube.com/@menuroom" target="_blank" rel="noopener noreferrer"
                 className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-orange-600 transition">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start space-x-3">
                ...
                <span>Addis Ababa, Ethiopia<br />Bole Road, Near Medhanealem</span>
              </li>
            </ul>
        ...
        <div className="mt-16 pt-10 border-t border-gray-800 text-center text-gray-500">
          <p className="text-sm">
            © {new Date().getFullYear()} Menuroom Technologies PLC. 
            All rights reserved. Made with <span className="text-red-500">❤</span> in Ethiopia
          </p>
          <p className="text-xs mt-3">
            Empowering Ethiopian restaurants with modern technology
          </p>
        </div>
        </div>
      </div>
